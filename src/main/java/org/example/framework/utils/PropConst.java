...
public class PropConst {
    ...
    public static final String OPTIONS_OFF_NOTIFICATIONS = "options.off.notifications";

    public static final String OPTIONS_MODE_INCOGNITO = "options.mode.incognito";
